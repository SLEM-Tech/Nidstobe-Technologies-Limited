...
export const SITE_NAME = "Nidstobe Technologies Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://nidstobe.com"; // Update with actual URL
export const TWITTER_HANDLE = "@NidstobeTechnologiesLimited";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "Nidstobe Technologies Limited Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "Nidstobe Technologies Limited",
  ...
  home: {
    ...
    description:
      "Innovate and grow with Nidstobe. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your Nidstobe client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "Nidstobe dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Nidstobe Technologies Limited and access premium tech resources.",
    keywords: [
      "Get started with Nidstobe",
      "Project onboarding",
      "Digital partnership",
    ],
  },
